...
public class Fire_elephant_trample extends FireInvocationTargetedSpell implements Invocation_spell {
    private static final String SPELL_NAME = "Elephant trample";

    public Fire_elephant_trample() {
        super(new Fire(),
                15,
                Effect.DAMAGE,
                9,
